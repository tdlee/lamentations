...
<body>
  ...
  <div class="content-area">
    ...
    <h2>Translation? Or something else?</h2>

    <p>
      I would like to call this a translation.
      But that opens up the thorny question of that term's definition.
      Getting hung up on the term itself would probably only take us down a long, dark rabbit-hole to a dead end.
    </p>
    ...
    <p>
      ...
      I then specifically redrafted in order to avoid its distraction.
    </p>
    ...
    <p>
      Hebrew poetry makes quite frequent use of wordplay.
      Several instances are mentioned in footnotes to the verses.
      Sometimes, something similar can be done in English translation;
      alliteration can be useful here.
    </p>
    ...
    <p>
      ...
      Examples include: "listen up" (1:18), "zero in" (1:22), "blitzed" (2:2), "blackout" (3:2), "hell-bent" (2:8), "slow-clap" (2:15), "snide-song" (3:63), "zilch" (3:64), "ziplock" (3:65), "firestorm" (4:11), "boozed" (4:21), "no-go zones" (4:18), "up to our necks" (5:5).
    ...
    <p>
      Contemporary writing and biblical translation rightly veer towards inclusive language, such as preferring "humankind" for "mankind".
      Indeed, for referencing humanity, this is also my approach in my own church hymnwriting and songwriting.
    </p>
    ...
    <p>
      ...
      This is intentional gendering.<?php
        Footnote('Boase (2008).');
      ?>

        ...
        <div class="poem__verse">
          ...
          <div class="poem__versetext">
              <?php
                ...
                $fn_death='The Hebrew syntax of this closing couplet is unclear. The verb "bereaved" from the first half seems carried across by implication into the second half; further, "Death" may be a personification, also supported by Jer.&nbsp;9:20.  This might then read as "indoors Death itself bereaves". See Berlin (2004), p.44 and Goldingay (2022), p.79. For deeper study, see Kotz&eacute; (2019).';
              ?>
